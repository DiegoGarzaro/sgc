...
class Component(models.Model):
    ...
    sub_category = models.ForeignKey(SubCategory, on_delete=models.PROTECT, related_name='components')
    package = models.ForeignKey(Package, on_delete=models.PROTECT, related_name='components')
    brand = models.ForeignKey(Brand, on_delete=models.PROTECT, related_name='components')
    ...
    image = models.ImageField(upload_to='component_images/', null=True, blank=True)  # New optional image field
